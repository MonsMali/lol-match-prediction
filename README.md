...
- Meta x Form interactions
- Scaling x Experience combinations
...
Red team scaling potential: +5.2%

Confidence Level: 94.2%
Prediction Time: 87ms
```
...
| **Validation Strategy** | Temporal splitting methodology | [`docs/SPLIT_STRATEGY_GUIDE.md`](docs/SPLIT_STRATEGY_GUIDE.md) |
...
```bibtex
@mastersthesis{conceicao2025lol,
  ...
  year={2025},
  school={Aarhus University, Business and Social Sciences},
