...
def run_training(
    ...
    Args:
        ...
        use_stratified_temporal: Use stratified temporal split
        use_enhanced_v2: Use enhanced v2 features
    ...
    # Save to history
    if not description:
        description = f"Training run - {'Enhanced v2' if use_enhanced_v2 else 'Standard'} features"
...
def main():
    ...
    parser.add_argument('--no-enhanced', action='store_true', help='Disable enhanced v2 features')
    ...
    run_training(
        ...
        use_stratified_temporal=not args.pure_temporal,
        use_enhanced_v2=not args.no_enhanced,
